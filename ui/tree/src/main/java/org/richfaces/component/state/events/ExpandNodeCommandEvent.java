 ...
 * 
 */
public class ExpandNodeCommandEvent extends TreeStateCommandNodeEvent {

	/**
	 * 
	 */
	private static final long serialVersionUID = -45469740253455657L;

	public ExpandNodeCommandEvent(UIComponent component, TreeRowKey rowKey) {
